...
return(
  <>
   <div>
      ...
      <h1 className={Modos? 'h1FotosNoturno':'h1FotosDiurno'}>Power Automate</h1>
  <br></br><br></br><br/><br/><br/>
  <img className={Modos? 'ImgFotosDiurno':'ImgFotosNoturno'} src="/Power Automate.png" alt="" />    
  <hr className="hr" />    
  <h1 className={Modos? 'h1FotosNoturno':'h1FotosDiurno'}>AWS</h1>  
  <br></br><br></br><br/><br/><br/>
  <img className={Modos? 'ImgFotosDiurno':'ImgFotosNoturno'} src="/AWL.png" alt="" />
  <hr className="hr" />
  <h1 className={Modos? 'h1FotosNoturno': 'h1FotosDiurno'}>Scrum</h1>
  <br></br><br></br><br/><br/><br/>
  <img className={Modos? 'ImgFotosDiurno': 'ImgFotosNoturno'} src="/Scrum.png" alt=""/>
  <hr className="hr"/>
  <h1 className={Modos? 'h1FotosNoturno': 'h1FotosDiurno'}>React Native</h1>
  <br></br><br></br><br/><br/><br/>
  <img className={Modos? 'ImgFotosDiurno':'ImgFotosNoturno'} src="/React Native.png" alt="" />
  
  <hr className="hr"/>
  <h1 className={Modos? 'h5FotosNoturno': 'h5FotosDiurno'}>CSS (Cascading Style Sheets)</h1>
  <br /><br /><br /><br /><br />
