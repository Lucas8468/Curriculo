      ...
      {/* Div que contém o Menu de configurações */}  
       <div>
        ...
        <div style={{backgroundColor: Modos? '#0f313b':'#01647d'}} className={Menu? 'NavbarVertical1':'NavbarVertical2'}>
            ...
            {Menu?<button style={{marginLeft: Traduzir? '':''}} className='ButtonTradutor' onClick={()=>setTraduzir(!Traduzir)} type='button'>{Traduzir?'Inglês':'Português'}</button>: null}
      ...
      <main>
        ...
        <h1 className={Modos? 'h1Noturno':'h1Diurno'}>Hard Skills</h1>
          <ul className={Modos? 'ul1Noturno':'ul1Diurno'}>
            ...
            <p className={Modos? 'text2Noturno':'text2Diurno'}>Typescript, React Native, Scrum, Google Charts, Linux (Ubuntu e Fedora), Electron.js, Next.js, Nextron.js, React Router DOM, Node.js, Mysql, Git, Excel, Powerpoint e Word</p>
            <hr className='hr'/>
        ...
        <ul className={Modos? 'ul1Noturno':'ul1Diurno'}>
         <li className={Modos? 'text2Noturno':'text2Diurno'}>{Traduzir?'Ensino Superior - 4º Semestre':'higher education - 4th semester'}</li>
        </ul>
        <hr className='hr'/>
      ...
      <ul className={Modos? 'ul1Noturno':'ul1Diurno'}>
        ...
        <ul className={Modos? 'ul1Noturno':'ul1Diurno'}>
          ...
          <li className={Modos? 'text4Noturno':'text4Diurno'}>{Traduzir?'Cargo Pretendido':'Desired Position'}</li>
            <p className={Modos? 'text2Noturno':'text2Diurno'}>{Traduzir?'Auxiliar administrativo, analista administrativo ou analista administrativo BI (Podendo ser incluído em cotas PCD)':'Administrative Assistant, Administrative Analyst, or Administrative Analyst (BI) (Eligible for inclusion in quotas for persons with disabilities)'}</p>
        </ul>
        <hr className='hr'/>
        <h5 className={Modos? 'AtualizacaoDiurna':'AtualizacaoNoturna'}>{Traduzir? 'Atualizado pela última vez em: 12/07/2026':  'Last updated on: 12/07/2026'}</h5>
      </main>
    </body>  
    </>
  )
